#ifndef __NETWORK_UMA_DEFINITION_H__
#define __NETWORK_UMA_DEFINITION_H__

#include <stdint.h>
#include <stddef.h>

namespace dg::network_uma_definition{

    using device_id_t           = uint8_t;
    using uma_ptr_t             = uint64_t; //convert uma_ptr_t -> object
    ...
    static inline constexpr uma_ptr_t NULL_VMA_PTR          = 0u;
